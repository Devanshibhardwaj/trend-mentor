    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="absolute bottom-20 right-4 w-[280px] z-40"
        >
          <Card className="overflow-hidden border-primary/20 shadow-xl">
            <div className="bg-primary p-3 text-white flex justify-between items-center">
              ...
              <button 
                onClick={onClose}
                className="text-white hover:bg-primary-foreground/10 p-1 rounded-full"
              >
                <X size={14} />
              </button>
            </div>
            
            <CardContent className="p-3 text-sm space-y-3 bg-card">
              <div className="flex items-start gap-2.5">
                <Shirt size={16} className="text-primary mt-0.5" />
              ...
              <div className="flex items-start gap-2.5">
                <CloudSun size={16} className="text-primary mt-0.5" />
                <span>Dress for the weather</span>
              </div>
            </CardContent>
          </Card>
        </motion.div>
